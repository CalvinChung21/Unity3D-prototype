...
public class TraumaInducer : Singleton<TraumaInducer>
{
    ...
    public IEnumerator InduceStress()
    {
        ...
        /* Find all game objects in the scene and loop through them until we find all the nearvy stress receivers */
