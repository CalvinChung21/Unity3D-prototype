...
public static class MapHelper
{
    public static void RandomlyChooseAndSetStartAndExit(MapGrid grid, ref Vector3 startPosition,
        ref Vector3 exitPosition, bool randomPlacement, Direction startPositionEdge = Direction.Left,
    ...
    private static Vector3 RandomlyChoosePositionOnTheEdgeOfTheGrid(MapGrid grid, Vector3 startPosition,
